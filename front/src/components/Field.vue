<template>
  <b-container>
    ...
    <b-row>
      ...
      <b-col
        ><b-form-file @change="onFileChange" accept="image/*" ref="file Input"></b-form-file
      ></b-col>
    </b-row>
    <b-row v-if="url">
      <b-col sm="1"></b-col>
      <b-col sm="3"
        ><img :src="url" style="max-width: 200px; max-height: 20 0px; object-fit: cover"
      /></b-col>
      <b-col
        ><b-button @click="removeImage"><b-icon-trash></b-icon-trash></b-button
      ></b-col>
    </b-row>
    <b-row>
      <b-col sm="1">
      ...
      <b-col sm="1">
        <b-button @click="changeLocState">
          ...
          <b-iconstack v-else>
            ...
            ><b-icon-slash-circle stacked s cale="1.5"></b-icon-slash-circle>
          </b-iconstack>
        </b-button>
      </b-col>
    </b-row>
...
export default {
  ...
  data: () => {
    return {
      ...
      fetchState: { disabled: false, animate: '' },
      text: '',
      lat: '',
      lon: '',
      url: '',
  ...
  methods: {
    ...
    async upload() {
      ...
      const result = await axios.post(process.env.VUE_APP_UPLOAD_URL, formdata, {
    ...
    async fetch() {
      ...
      console.log(process.env.VUE_APP_FETCH_URL);
      console.log(result);
