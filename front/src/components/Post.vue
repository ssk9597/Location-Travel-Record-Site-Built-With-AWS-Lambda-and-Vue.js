<template>
  <b-container>
    <b-row>
      <b-col sm="1"><b-icon-watch></b-icon-watch></b-col> <b-col>{{ datetime | unixtodate }}</b-col>
    </b-row>
    <b-row>
    ...
    <b-row v-if="lat && lon">
      ...
      <b-col>
        <iframe
          ...
          style="border: 0"
          :src="
            `https://www.google.com/maps/embed/v1/place?key=AIzaSyDywIsWVTc9_jIKIJAomy2iwYPU6gkzwAs&zoom=15&q=${lat} ,${lon}`
          "
        >
        </iframe>
      </b-col>
